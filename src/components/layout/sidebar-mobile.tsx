...
export default function SidebarMobile() {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "md:hidden fixed top-0 left-0 bottom-0 z-50 w-72 bg-background border-r border-border transform transition-transform duration-300 ease-in-out flex flex-col",
      ...
      >
        ...
        <div className="border-t border-border p-3 shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-destructive hover:bg-destructive/10 transition-all duration-200 w-full cursor-pointer"
          >
            <LogOut size={16} />
            Terminar Sessão
          </button>
