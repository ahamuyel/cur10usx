    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-0 md:gap-0 items-stretch">
          <div className="border border-[var(--landing-border)] bg-[var(--landing-bg-elevated)] p-6 md:p-8 rounded-xl md:rounded-r-none transition-all duration-300 hover:border-[var(--landing-border-strong)]">
            <span className="text-[10px] font-semibold text-[var(--landing-text-dim)] uppercase tracking-widest block mb-2 md:mb-3">
              {t("landing.how_it_works.level1_label")}
            </span>
            <h3 className="text-base md:text-lg font-bold text-[var(--landing-text-primary)] mb-2 md:mb-3">
          ...
          <div className="border border-[var(--landing-border)] bg-[var(--landing-bg-elevated)] p-6 md:p-8 rounded-xl md:rounded-l-none transition-all duration-300 hover:border-[var(--landing-border-strong)] md:border-l-0">
            <span className="text-[10px] font-semibold text-[var(--landing-text-dim)] uppercase tracking-widest block mb-2 md:mb-3">
        ...
        <div className="flex md:hidden items-center justify-center mt-3">
          <ArrowRight size={16} className="text-[var(--landing-text-muted)] rotate-90" />
        </div>
      </div>
    </section>
  )
